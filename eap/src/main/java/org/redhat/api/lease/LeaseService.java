...
public class LeaseService {
	...
	public LeaseModel findByProcess(String processInstanceId) {
		TypedQuery<LeaseModel> query = em.createQuery(
				...
				.setParameter("processInstanceId", Integer.valueOf(processInstanceId));
	...
	public LeaseModel updateProcessInstanceId(String id, String processInstanceId) {
